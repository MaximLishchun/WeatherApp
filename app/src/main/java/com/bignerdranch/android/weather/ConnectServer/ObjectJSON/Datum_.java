package com.bignerdranch.android.weather.ConnectServer.ObjectJSON;
...
public class Datum_ {
    ...
    public Double getApparentTemperatureHigh() {
        return ((apparentTemperatureHigh-32)*5)/9;
    }
    ...
    public Double getApparentTemperatureMin() {
        return ((apparentTemperatureMin-32)*5)/9;
    }
    ...
    public Double getApparentTemperatureMax() {
        return ((apparentTemperatureMax-32)*5)/9;
    }
